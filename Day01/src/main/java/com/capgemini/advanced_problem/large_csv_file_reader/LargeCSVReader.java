package com.capgemini.advanced_problem.large_csv_file_reader;
...
public class LargeCSVReader {
    ...
    public static void main(String[] args) {
        String filePath = "src/main/java/com/capgemini/advanced_problem/large_csv_file_reader/Students.merged.csv"; // Path to the large CSV file
