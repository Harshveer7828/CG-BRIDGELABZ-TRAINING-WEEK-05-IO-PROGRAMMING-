package com.capgemini.advanced_problem.merge_csv_file;
...
public class MergeCSVFiles {
    ...
    public static void main(String[] args) {
        String file1 = "src/main/java/com/capgemini/advanced_problem/merge_csv_file/file1.csv";
        String file2 = "src/main/java/com/capgemini/advanced_problem/merge_csv_file/file2.csv";
        String outputFile = "src/main/java/com/capgemini/advanced_problem/merge_csv_file/merged.csv"; // Output merged file
